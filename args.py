...
def get_train_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='cfgs/YOLOv3_step_fine_tune', type=str, help='config file path')
    ...
    parser.add_argument('--batch-size', default=2, type=int, help='number of batchsize')
...
def get_eval_args_parser(add_help=True):
    ...
    parser.add_argument('--force-eval', action='store_true', help='if force eval')
    return parser
