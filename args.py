...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='default_config.yaml', type=str, help='config file path')
    ...
    parser.add_argument('--batch-size', default=4, type=int, help='number of batchsize')
